    ...
    do {
        ...
        switch (choice) {
            case 1: {
                ...
                send(newSocket, "Student information added successfully",
                     sizeof("Student information added successfully"), 0);
                break;
            }
        }
        case 2: {
            ...
            if (found) {
                ...
                send(newSocket, "Student with specified ID not found", sizeof("Student with specified ID not found"),
                     0);
            }
            break;
        }
        case 3: {
            ...
            if (found) {
                ...
                send(newSocket, "No student found with score above specified score",
                     sizeof("No student found with score above specified score"), 0);
            }
            break;
        }
        case 4: {
        ...
        case 5: {
            ...
            // Send acknowledgment to the client
            if (deleted) {
                send(newSocket, "Student information deleted successfully",
                     sizeof("Student information deleted successfully"), 0);
            } else {
                send(newSocket, "Student with specified ID not found", sizeof("Student with specified ID not found"),
                     0);
            }
...
int main(int argc, char **argv) {
    ...
    do {
        // Receive client's choice
        if (recv(newSocket, &choice, sizeof(choice), 0) < 0) {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                if (found) {
                    ...
                    // If student with given ID is not found, send appropriate message to client
                    send(newSocket, "Student with specified ID not found",
                         sizeof("Student with specified ID not found"), 0);
                }
                break;
                break;
            }
            ...
            case 4: {
                ...
                if (studentCount > 0) {
                    ...
                    // If no students are found in the database, send appropriate message to client
                    send(newSocket, "No students found in the database", sizeof("No students found in the database"),
                         0);
                }
                break;
                break;
